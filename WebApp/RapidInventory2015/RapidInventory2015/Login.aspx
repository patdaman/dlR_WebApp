<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="Login.aspx.cs" Inherits="RapidInventoryWebApp.Login" %>
...
<body>
	<form id="login" runat="server" class="pure-form" autocomplete="off">
	...
	<table>
		...
		<tr>
			...
			<td align="center" class="auto-style1">
				<asp:TextBox id="UserName" runat="server" Width="150px" CssClass="field" AutoCompleteType="Disabled"></asp:TextBox>
		...
		<tr>
			...
			<td align="center">
				<asp:TextBox id="Password" runat="server" textMode="Password" Width="150px" CssClass="field" AutoCompleteType="Disabled"></asp:TextBox>
		...
		<tr>
			<td style="display:none">Persistent Cookie:</td>
			<td style="display:none" ><ASP:CheckBox id="chkPersistCookie" runat="server" autopostback="false" /></td>
			<td></td>
		</tr>
		 <tr class="submit" >
