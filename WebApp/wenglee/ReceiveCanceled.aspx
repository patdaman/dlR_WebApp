<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReceiveCanceled.aspx.vb" Inherits="Success" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Rapid POS Mobile WL - Receiver Canceled</title>
...
<body bgcolor="#FFFFFF">
    ...
    <tr>
        <td colspan="3" align="center"><h3>Rapid POS Mobile WL<br />Receiver Canceled</h3></td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="center" height="3" class="td_text">All items in the receiver have been CANCELED. If you did not intend to cancel, you will need to
         scan the items again in a new receiver.</td>
    </tr>    
    <tr>
