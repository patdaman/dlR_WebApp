<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OrderSearchListCustomer.aspx.vb" Inherits="_Default" %>
...
<head id="Head1" runat="server">
    <title>Rapid POS Mobile WL - Order - Search Customer</title>
...
<body bgcolor="#FFFFFF">
    ...
    <tr>
        <td class="td_text"><strong>All Customers</strong></td>
    </tr>
    <tr>
        <td>
